...
function Playlist() {
  ...
  return (
    <div className="playlist">
      ...
      <Cloud offset={30+songsOffset} cloudSongs={songs.slice(30+songsOffset, 30+16+songsOffset)} intro={true} delay={0} introOrder={2}/>
      <Row offset={0+songsOffset} cloudSongs={songs.slice(songsOffset, 10+songsOffset)} x='0'y='100' introOrder={2} cloudDelay={0}/> 
