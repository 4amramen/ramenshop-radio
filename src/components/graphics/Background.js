...
//final gradients
  ...
  'linear-gradient( 122.3deg,  rgba(111,71,133,1) 14.6%, rgba(232,129,166,1) 29.6%, rgba(237,237,183,1) 42.1%, rgba(244,166,215,1) 56.7%, rgba(154,219,232,1) 68.7%, rgba(238,226,159,1) 84.8% )',  //.3
  ...
  'linear-gradient( 179.7deg,  rgba(7,13,22,1) 51%, rgba(24,33,48,1) 63.7%, rgba(66,78,71,1) 83.2%, rgba(146,88,53,1) 100.8% )',
  'linear-gradient( 74.3deg,  rgba(68,17,28,1) 17.4%, rgba(95,24,40,1) 34.7%, rgba(122,31,51,1) 51.8%, rgba(149,38,62,1) 67.4%, rgba(163,41,68,1) 89.6% )',

//needs opacity adjustment
  'linear-gradient(-225deg, #5D9FFF 0%, #B8DCFF 48%, #6BBBFF 100%)',
  'linear-gradient(-225deg, #5271C4 0%, #B19FFF 48%, #ECA1FE 100%)',
  'linear-gradient(to top, #0c3483 0%, #a2b6df 100%, #6b8cce 100%, #a2b6df 100%)', //.45
  'linear-gradient(to bottom, #093028, #237a57)', //.45
  'linear-gradient(to right, #396afc, #2948ff)',
  'linear-gradient(to right, #159957, #155799)',
  ' linear-gradient(to top, #9d50bb, #6e48aa)',
...
'radial-gradient( circle 880px at -0.7% 57.1%,  rgba(202,149,149,1) 0%, rgba(239,215,177,1) 14.3%, rgba(239,239,177,1) 27.4%, rgba(191,239,177,1) 40.1%, rgba(177,239,217,1) 48.7%, rgba(177,238,239,1) 56.7%, rgba(177,180,239,1) 73.2%, rgba(224,177,239,1) 89.8%, rgba(239,177,231,1) 100.2% )',
  ...
  return (
    <div className="transition-backgrounds">
      {/* <div className="background-test" style={{opacity: .5 , background:
      'linear-gradient(to top, #dc2424, #4a569d)'
}}/> */}
